...
const APP_CONFIG_ENV: {
  ...
  nicehash_order_expiry_alert_days: {
    varName: 'BHA_NICEHASH_ORDER_EXPIRY_ALERT_DAYS',
    coerce: asNumber,
  },
  cheap_mode_slabs: { varName: 'BHA_CHEAP_MODE_SLABS', coerce: asString },
  cheap_mode_slabs_enabled: { varName: 'BHA_CHEAP_MODE_SLABS_ENABLED', coerce: asBoolean },
